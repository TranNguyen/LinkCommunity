 ...
 */
	public function testInputSelectType() {
		...
		$result = $this->Form->input('Publisher.php.id', array(
				'label'		=> 'Publisher.php',
				'type'		=> 'select',
				'multiple'	=> 'checkbox',
		...
		$expected = array(
			array('div' => array('class' => 'input select')),
				...
				'Publisher.php',
				'/label',
				'input' => array('type' => 'hidden', 'name' => 'data[Publisher.php][id]', 'value' => '', 'id' => 'PublisherId'),
				array('div' => array('class' => 'checkbox')),
				array('input' => array('type' => 'checkbox', 'name' => 'data[Publisher.php][id][]', 'value' => 'Value 1', 'id' => 'PublisherIdValue1')),
				array('label' => array('for' => 'PublisherIdValue1')),
				'Label 1',
				'/label',
				'/div',
				array('div' => array('class' => 'checkbox')),
				array('input' => array('type' => 'checkbox', 'name' => 'data[Publisher.php][id][]', 'value' => 'Value 2', 'id' => 'PublisherIdValue2')),
